      ...
      <div class="footer-brand">
        ...
        <div class="footer-social">
          ...
          <a href="https://www.facebook.com/" class="social-link" aria-label="Facebook" target="_blank" rel="noopener">
            <svg viewBox="0 0 24 24" fill="currentColor"><path d="M13.5 8.5V6.8c0-.8.5-1.3 1.3-1.3H17V2h-2.8C11 2 9.5 4 9.5 6.8v1.7H7V12h2.5v10h4V12H17l.5-3.5h-4z"/></svg>
          </a>
          <a href="https://www.instagram.com/" class="social-link" aria-label="Instagram" target="_blank" rel="noopener">
          ...
          <a href="https://www.tiktok.com/" class="social-link" aria-label="TikTok" target="_blank" rel="noopener">
            <svg viewBox="0 0 24 24" fill="currentColor"><path d="M14.5 3v10.1a3.4 3.4 0 11-2.4-3.2V7.4a6 6 0 102.4 5.1V8.8a6.6 6.6 0 003.9 1.3V7.7a4.2 4.2 0 01-3.9-4.7z"/></svg>
          </a>
