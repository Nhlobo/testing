    ...
    <div class="footer-grid">
      ...
      <div class="footer-brand">
        ...
        <div class="footer-social">
          ...
          <a href="https://tiktok.com/@mapengoinnovations" class="social-link" aria-label="TikTok" target="_blank" rel="noopener">
            <svg viewBox="0 0 24 24" fill="currentColor"><path d="M15.5 3c.5 1.6 1.7 2.8 3.3 3.3v2.6a8.2 8.2 0 01-3.3-.9v6.1a5.1 5.1 0 11-5.1-5.1c.3 0 .5 0 .8.1v2.8a2.4 2.4 0 00-.8-.1 2.3 2.3 0 102.3 2.3V3h2.8z"/></svg>
          </a>
        </div>
      </div>
