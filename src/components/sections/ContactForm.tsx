...
export function ContactForm() {
  ...
  const inputClass = (hasError?: string) =>
    `w-full px-4 py-3 rounded-lg bg-navy-700 border ${
      hasError ? "border-red-500" : "border-navy-600"
    } text-white placeholder-slate-500 text-sm focus:outline-none focus:border-accent transition-colors`;
          ...
          <AnimatedSection direction="left">
            ...
            <div className="space-y-4">
              <a
                ...
                className="flex items-center gap-4 p-4 rounded-xl bg-navy-800 border border-navy-700 hover:border-accent/30 transition-colors group"
              >
              ...
              <a
                ...
                className="flex items-center gap-4 p-4 rounded-xl bg-navy-800 border border-navy-700 hover:border-green-400/30 transition-colors group"
              >
                <div className="w-10 h-10 rounded-lg bg-green-400/10 flex items-center justify-center text-green-400 shrink-0">
          ...
          <AnimatedSection direction="right">
            ...
            >
              ...
              <div className="space-y-4">
                ...
                {/* Email */}
                <div>
                  <label htmlFor="email" className="block text-sm text-slate-300 font-medium mb-1.5">
                ...
                {/* Phone (optional) */}
                <div>
                  <label htmlFor="phone" className="block text-sm text-slate-300 font-medium mb-1.5">
                    Phone Number{" "}
                ...
                {/* Service */}
                <div>
                  <label htmlFor="service" className="block text-sm text-slate-300 font-medium mb-1.5">
                    Service Needed
                  </label>
                  <select
                    id="service"
                ...
                {/* Message */}
                <div>
                  <label htmlFor="message" className="block text-sm text-slate-300 font-medium mb-1.5">
              ...
              <button
                ...
                className="mt-6 w-full flex items-center justify-center gap-2 px-6 py-4 rounded-xl bg-accent text-white font-semibold hover:bg-accent-dark transition-all disabled:opacity-60 disabled:cursor-not-allowed shadow-lg hover:shadow-accent/25"
              >
                {status === "loading" ? (
                  <>
                    <svg
